...
.. The board of elders will be concerned with discipline in the church. Should they become aware of a need for discipline, a member of the elders shall speak with the individual involved with the hope for reconciliation and, if needed, repentance.
